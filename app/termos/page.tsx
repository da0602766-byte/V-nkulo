  ...
  return (
    <main className="pilot-legal-shell">
      ...
      <article className="pilot-legal-card">
        ...
        <h2>7. Conta Google e Google Drive</h2><p>O login com Google e a conexão do Google Drive são opcionais e independentes. O usuário pode solicitar a exclusão da conta e dos dados a qualquer momento, conforme a <Link href="/privacidade">Política de Privacidade</Link> e a página de <Link href="/exclusao-de-dados">Exclusão de conta e de dados</Link>.</p>
